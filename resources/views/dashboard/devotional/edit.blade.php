...
@section('content')
    ...
    <div class="container">
        <form method="POST" action="{{ route('dashboard.devotion.update-devotion', $devotion->id) }}" enctype="multipart/form-data">
            ...
            <textarea type="text" name="opening_prayer" id="opening_prayer" class="form-control"></textarea>

            <label for="topic" class="form-label">Topic: </label>
            <input type="text" name="topic" id="topic" class="form-control">

            <label for="bible_text" class="form-label">Bible Text: </label>
            <input type="text" name="bible_text" id="bible_text" class="form-control">

            <label for="memory_verse" class="form-label">Memory Verse: </label>
            <input type="text" name="memory_verse" id="memory_verse" class="form-control">
            
            <label for="devotion" class="form-label">Devotion: </label>
            <textarea type="text" name="devotion" id="devotion" class="form-control"></textarea>
