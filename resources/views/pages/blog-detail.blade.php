	...
	<section class="banner position-relative mt-5">
		...
		<div class="parallax" style="background-image: url('{{ asset('assets/img/hero-image.png') }}');"></div>
			...
			<div class="banner-data text-center">
				...
				<h2 class="text-white font-bold">Devotional Detail</h2>

				<ul class="flex-all">


					<li><a href="JavaScript:void(0)" class="text-white">Devotional's Detail</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12 col-sm-12">
					...
					<div class="blog-meta">
						...
						<img class="img-fluid w-100" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="Blog image">

						<ul>
							<li class="date">21 Dec, 2021</li>
						</ul>

						<h2>Rev. Peter Mayah Talks About Church Leadership And Priesthood</h2>
					...
					<div class="content">
						...
						<p>
							...
							<img class="img-fluid w-100" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="Blog img">
						...
						<div class="gallery">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									...
									<figure>
										<img class="img-fluid w-100" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="blog-gal-1">
										<a data-fancybox="gallery" href="{{ asset('assets/img/Pst-Peter.jpeg') }}"><img src="{{ asset('assets/images/plus.svg') }}" ></a>
									</figure>
{{-- TODO:Fix this plus image issue here --}}
								</div>
								...
								<div class="col-lg-6">
									...
									<figure>
										<img class="img-fluid w-100" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="blog-gal-2">
										<a data-fancybox="gallery" href="{{ asset('assets/img/Pst-Peter.jpeg') }}"><img src="{{ asset('assets/images/plus.svg') }}" ></a>
									</figure>
					...
					<aside>
						...
						<div class="blog-sidebar">
							...
							<div class="widget widget-recent-articles">
								...
								<h3>Recent Devotions</h3>

								<ul>

									<li class="d-flex align-items-center">

										<img class="rounded-circle" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="Sidebar Image">
									...
									<li class="d-flex align-items-center">
										...
										<img class="rounded-circle" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="Sidebar Image One">
									...
									<li class="d-flex align-items-center">
										...
										<img class="rounded-circle" src="{{ asset('assets/img/Pst-Peter.jpeg') }}" alt="Sidebar Image Two">
