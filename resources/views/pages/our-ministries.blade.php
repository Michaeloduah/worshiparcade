...
<body>
	...
	<section class="banner position-relative">
		...
		<div class="parallax" style="background-image: url(assets/images/banner.webp);"></div>
			...
			<div class="banner-data text-center">
				...
				<h2 class="text-white font-bold">Our Ministries</h2>

				<ul class="flex-all">

					<li><a href="JavaScript:void(0)" class="text-white">Home</a></li>

					<li><a href="JavaScript:void(0)" class="text-white">Our Ministries</a></li>
	...
	<section class="gap our-ministries">
		...
		<div class="heading">
				...
				<h2 class="m-auto">The Blesso Church is Committed to Safeguarding as an Integral Part of Its Life, Mission and Ministry</h2>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy1" src="assets/images/ministry1.webp">

						<a href="JavaScript:void(0)" class="font-bold flex-all position-relative">Ladies Ministry</a>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy2" src="assets/images/ministry2.webp">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy3" src="assets/images/ministry3.webp">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy4" src="assets/images/ministry4.webp">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy5" src="assets/images/ministry5.webp">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy6" src="assets/images/ministry6.webp">
