...
<!-- Banner Start -->
	...
	<section class="gap our-ministries">
		...
		<div class="heading">
				...
				<h2 class="m-auto">The Worship Arcade Community Church is Committed to Mission and Ministry</h2>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy1" src="{{ asset('assets/img/ministries1.jpeg') }}">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy2" src="{{ asset('assets/img/ministries2.jpeg') }}">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy3" src="{{ asset('assets/img/ministries3.jpeg') }}">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy4" src="{{ asset('assets/img/ministries1.jpeg') }}">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy5" src="{{ asset('assets/img/ministries2.jpeg') }}">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					...
					<div class="ministry text-center light-bg position-relative">
						...
						<img class="rounded-circle position-relative img-fluid w-100" alt="ministy6" src="{{ asset('assets/img/ministries3.jpeg') }}">
