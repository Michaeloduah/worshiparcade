  ...
  <body>
    ...
    <section class="banner position-relative">
      ...
      <div class="banner-data text-center">
        <h2 class="text-white font-bold">Sermon Detail</h2>

        <ul class="flex-all">
          <li><a href="JavaScript:void(0)" class="text-white">Home</a></li>

          <li>
            <a href="JavaScript:void(0)" class="text-white">Sermon Detail</a>
          </li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="sermon-meta w-85 m-auto">
            ...
            >
              <h2 class="w-60">Spiritually Reborn As God’s Children</h2>
              ...
              <ul class="sermon-icons d-flex">
                ...
                <li>
                  <a
                    class="flex-all green-bg rounded-circle s_pdf"
                    href="JavaScript:void(0)"
                    ><svg
                      id="bossfsok"
                ...
                <li>
                  <a
                    class="flex-all green-bg rounded-circle s_music"
                    href="JavaScript:void(0)"
                    ><svg
                      version="1.1"
                      id="dfgdfgownload"
                    ...
                    >
                      <g>
                        <g>
                          <path
                            d="M483.6,295.25l-69.5-107.4c-5.4-8.3-14.5-13.3-24.4-13.3H359c-4.5,0-7.2,5-4.7,8.7l75,116c1,1.5-0.1,3.5-1.9,3.5h-32.9 h-26.8H342c-3.1,0-5.5,2.5-5.7,5.5c-2.9,48.4-43,86.8-92.2,86.8s-89.3-38.4-92.2-86.8c-0.2-3.1-2.6-5.5-5.7-5.5h-25.7h-23H60.9 c-1.8,0-2.8-2-1.9-3.5l75-116c2.4-3.8-0.3-8.7-4.7-8.7H98.6c-9.9,0-19,5-24.4,13.3L4.8,295.25c-3.1,4.8-4.8,10.5-4.8,16.3v149.6 c0,14.6,11.9,26.5,26.5,26.5h217.7h217.7c14.6,0,26.5-11.9,26.5-26.5v-149.6C488.4,305.75,486.8,300.15,483.6,295.25z"
                          />
                          <path
                            d="M236.2,299.45c4.1,5.2,12,5.2,16.1,0l65.9-83.8c5.3-6.7,0.5-16.6-8-16.6h-26V40.75c0-22.1-17.9-40-40-40l0,0 c-22.1,0-40,17.9-40,40v158.3h-26c-8.5,0-13.3,9.9-8,16.6L236.2,299.45z"
                          />
                        </g>
                      </g>
                      <g></g>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <figure>
                    <img
                      class="img-fluid w-100"
                      src="assets/images/event-gal-1.webp"
                      alt="event-gal-1"
                    />
                    <a
                      data-fancybox="gallery"
                      href="assets/images/event-gal-1.webp"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <figure>
                    <img
                      class="img-fluid w-100"
                      src="assets/images/event-gal-2.webp"
                      alt="event-gal-2"
                    />
                    <a
                      data-fancybox="gallery"
                      href="assets/images/event-gal-2.webp"
                      ><img src="assets/images/plus.svg" alt="Plus"
                    /></a>
                  </figure>
                </div>
          ...
          <div class="pagination">
            <ul>
              <li class="d-flex align-items-center prev">
                <span class="theme-bg-clr flex-all rounded-circle"
                  ><a class="flex-all" href="JavaScript:void(0)"
                    ><svg
                      version="1.1"
                      id="leftarrow"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      ...
                      <g></g></svg></a></span
                ><a href="JavaScript:void(0)"
                  >Life-asserting Sermons on the 23rd Psalm</a
                >
              </li>

              <li class="d-flex align-items-center next">
                <a href="JavaScript:void(0)" class="next"
                  >Praise the Lord with All Your Inmost Being</a
                ><span class="theme-bg-clr flex-all rounded-circle"
                  ><a class="flex-all" href="JavaScript:void(0)"
                    ><svg
                      version="1.1"
      ...
      <div class="container">
        <div class="row part-one">
          <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <p class="text-white">
              CHURCH AUDITORIUM: PAMOR CENTER, Interbua Roundabout, by First
              Bank Plc, Asaba, Delta State.
            </p>
