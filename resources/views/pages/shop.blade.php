...
<body>
	...
	<section class="banner position-relative">
		...
		<div class="parallax" style="background-image: url(assets/images/banner.webp);"></div>
			...
			<div class="banner-data text-center">
				...
				<h2 class="text-white font-bold">Shop</h2>

				<ul class="flex-all">

					<li><a href="index.html" class="text-white">Home</a></li>

					<li><a href="JavaScript:void(0)" class="text-white">Shop</a></li>
	...
	<section class="gap church-products">
		<div class="heading">
			...
			<p>Things Jesus did in his Ministry</p>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-12" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1500">
					<div class="product light-bg">
						<div class="thumbnail">
							<figure class="text-center">
								<img src="assets/images/p-5.webp" alt="Product Image">
							</figure>
				...
				<div class="col-lg-3 col-md-6 col-sm-12" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1500">
					<div class="product light-bg">
						<div class="thumbnail">
							<figure class="text-center">
								<img src="assets/images/p-6.webp" alt="Product Image">
							</figure>
				...
				<div class="col-lg-3 col-md-6 col-sm-12" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1500">
					<div class="product light-bg">
						<div class="thumbnail">
							<figure class="text-center">
								<img src="assets/images/p-7.webp" alt="Product Image">
							</figure>
				...
				<div class="col-lg-3 col-md-6 col-sm-12" data-aos="fade-down" data-aos-delay="1000" data-aos-duration="1500">
					<div class="product light-bg">
						<div class="thumbnail">
							<figure class="text-center">
								<img src="assets/images/p-8.webp" alt="Product Image">
							</figure>
